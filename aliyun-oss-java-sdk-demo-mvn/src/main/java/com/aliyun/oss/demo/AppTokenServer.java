...
/**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String accessKeyId = "LTAI4G4cmHoGcFQrJdApC68t";
		String accessKeySecret = "3Jo2JaguTqQFNDpLwQcHy0ZhoRaMkK";
		
		// RoleArn 需要在 RAM 控制台上获取
		String roleArn = "acs:ram::1671492361608297:role/aliyunosstokengeneratorrole";
		long durationSeconds = 3600;
		String policy = ReadJson("policy/bucket_write_policy.txt");
